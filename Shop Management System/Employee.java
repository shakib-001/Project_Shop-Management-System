...
public class Employee extends  JFrame implements ActionListener,MouseListener
{
    ...
    public Employee(String adminUsername,Shop s, Owner o,Homepage h)
    {
        ...
        hPage.setFont(new Font("Segoe UI Emoji",0,20        ));
        leftPanel.add(hPage);
        this.add(leftPanel);
...

{
   if (e.getSource() == backButton)
   {
    ...
    Homepage h = new Homepage(adminUsername,s,o,this);

    Management m = new Management(s,h,this,o);
    m.setVisible(true);
