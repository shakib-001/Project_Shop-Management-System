...
public class Management extends JFrame implements ActionListener,MouseListener
{
    ...
    JPanel leftPanel;
    JButton productMNG,employeeMNG,shopINFO,exitButton,backButton, profile;
    Font font;
    Shop s;
    Homepage h;
    Employee em;
    ...
    public Management(Shop s,Homepage h,Employee em, Owner o)
    {
        ...
        profile.setBounds(990, 50, 100, 40);
     ...
     public void actionPerformed(ActionEvent e)
    {
         ...
         if(productMNG.getText().equals(command))
       {
         ...
         else if(employeeMNG.getText().equals(command))
          {
      ...
      else if(shopINFO.getText().equals(command))
       {
           
          
             String adminLocation = s.shopidTF.getText();
             String adminPassword = new String(s.userPasswordField.getPassword());
             


             ShopInfo i = new ShopInfo(adminUsername,adminLocation,adminPassword,s,h,em,o);
             i.setVisible(true);
             this.setVisible(false);   
    	...
    	{
         String Ownername=o.ownernameField.getText();
         String OwnerLocation=o.addressTF.getText();
         String OwnerNum=o.ownernumTF.getText();

         OwnerInfo oi= new OwnerInfo(Ownername, OwnerLocation, OwnerNum,s, h, em, o);
         oi.setVisible(true);
         this.setVisible(false);
